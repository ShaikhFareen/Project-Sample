    ...
    if mailentry.get() == '':
        ...
        try:
            ...
            if row == None:
                ...
                passwordimage = PhotoImage(file='images/pass.png')
                ...
                securityquescombo['values'] = (
                    'Select', 'Your First Name?', 'Your Birth Place Name?', 'Your Best Friend Name?',
...
bglogin = PhotoImage(file='images/loginbg.png')
